...
bool Plane::intersects(Ray ray, float &t, DotDir &p)
{
...
DotDir Plane::getNormal()
{
    return normal;
}

DotDir Plane::getCenter()
{
    return center;
}

void Plane::getBase(DotDir interseccion, DotDir &base0, DotDir &base1, DotDir &base2)
{
    base2 = normal;
...
void Plane::setNormal(DotDir _normal)
{
    normal = _normal;
}

rgb Plane::getTexture(const DotDir &interseccion)
{
