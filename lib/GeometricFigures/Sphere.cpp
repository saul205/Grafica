...
Sphere::Sphere(const DotDir &center, const DotDir &axis, const DotDir &city)
{
    sphereCenter = center;
    sphereAxis = axis;
    sphereCity = city;
...
bool Sphere::intersects(Ray ray, float &t, DotDir &p)
{
    ...
    else if (doSquareRoot == 0)
    {                                 // Una solución, t es tangente a la esfera
...
rgb Sphere::getTexture(const DotDir &interseccion)
{
...
/*
    ...
    */
void Sphere::getBase(DotDir base[3])
{
...
void Sphere::getBase(DotDir interseccion, DotDir &base0, DotDir &base1, DotDir &base2)
{
...
DotDir Sphere::getAxis()
{
    return sphereAxis;
}

DotDir Sphere::getCity()
{
    return sphereCity;
}

DotDir Sphere::getCenter()
{
    return sphereCenter;
}
...
PlanetaryStation::PlanetaryStation(Sphere sph, float incl, float azi)
{
    ...
    cout << "Posicion Local: " << position.toString() << endl
         << endl;
    ...
    cout << "Base UCS a local" << endl
         << ucsLocal.toString() << endl;
    cout << "Base local a UCS" << endl
         << localUCS.toString() << endl;

    position = localUCS * position;

    cout << "Posicion UCS: " << position.toString() << endl
         << endl;
...
void conection(const PlanetaryStation &origen, const PlanetaryStation &destino)
{
    ...
    cout << "Posiciones " << destino.position.toString() << " | " << origen.position.toString() << endl
         << endl;
    ...
    cout << "Base Ucs a posicion Origen" << endl
         << ucsToPositionOrigen.toString() << endl
         << endl;
    ...
    cout << "Base Ucs a posicion Destino" << endl
         << ucsToPositionDestino.toString() << endl
         << endl;
