...
BoundingBox::BoundingBox(DotDir _top, DotDir _bottom)
{
...
bool BoundingBox::intersects(Ray ray, float &t)
{
...
bool BoundingBox::intersects(Ray ray, float &t) const
{
...
DotDir BoundingBox::getTop()
{
    return top;
}

DotDir BoundingBox::getBottom()
{
    return bottom;
}

int BoundingBox::MaxAxe()
{
