...
int main(){
    ...
    cout << "Dirección más dirección: " << dd4.toString() << " módulo: " << dd4.mod() << endl;
    cout << "Dirección más punto:     " << dd5.toString() << " módulo: " << dd5.mod() << endl;
    cout << "Punto más dirección:     " << dd6.toString() << " módulo: " << dd6.mod() << endl;
    cout << endl;
    cout << "Dirección menos dirección: " << dd7.toString() << " módulo: " << dd7.mod() << endl;
    cout << "Punto menos punto:     " << dd8.toString() << " módulo: " << dd8.mod() << endl;
    cout << "Punto menos dirección:     " << dd9.toString() << " módulo: " << dd9.mod() << endl << endl;
